<template>
  <ScrollableContainer>
    <div class="container-fluid" style="padding-bottom: 80px">
      ...
      <!-- PIC Theme -->
      <!-- <div class="card" v-if="isProblemClose && !isMemberThema">
        <div class="card-header bg-info">Focuss Thema</div>
        <div class="row m-0 p-0">
          <div class="col-md-6 col-xs-12 px-1 text-left">
            <span class="input-lable">PIC Thema</span>
            <input
              class="form-control"
              type="text"
              disabled
            ...
            <multiselect
              v-model="picThema"
              :options="optOperatorsThema"
              placeholder="Pilih PIC"
              style="font-size: 10px"
            ></multiselect>
          </div>
          <div class="col-md-6 col-xs-12 px-1 text-left">
            <span class="input-lable">Target Problem Close</span>
            <input class="form-control" type="date" v-model="datePlanTheme" />
          </div>
          <div class="col-md-12 col-xs-12 px-1">
            <button class="btn btn-sm btn-success" @click="addMemberTheme()">
              Add PIC Problem
            </button>
          </div>
        </div>
      </div>
      <div class="card col-xs-6 col-md-12" v-else>
        <div class="card-header bg-outline-sucess p-1">PIC Tema Problem</div>
        <div class="row">
          <div class="col-xs-6 col-md-12">
            <table>
              <tr>
                <th>Image</th>
                <th>Name</th>
                <th>Target Thema Problem Close</th>
                <th>Status</th>
              </tr>
              <tr>
                <td>
                  <img :src="imgPicThema" height="100" width="100" />
                </td>
                <td>
                  {{ picThema }}
                </td>
      ...
      <div class="card mt-2">
        <div class="card-header bg-warning">Focuss Thema</div>
        <div class="row m-0 p-0">
          <div class="col-md-12 col-xs-12 px-1 text-left">
            <span class="input-lable">PIC Thema</span>
            <input
              class="form-control"
              type="text"
        ...
        <div class="row m-0 p-0">
          <div class="col-md-6 col-xs-12 px-1 text-left">
            <span class="input-lable"
              >Start Date Focus thema (otomatis terisi saat pic di pilih)</span
            >
            <input
              class="form-control"
              type="date"
              disabled
              v-model="initDateThema"
            />
          </div>
          <div class="col-md-6 col-xs-12 px-1 text-left">
            <span class="input-lable"
              >Target Finish Date Focus thema (otomatis terisi saat menambah
            ...
            <input
              ...
              type="date"
              disabled
              v-model="datePlanTheme"
            />
          </div>
        </div>
        <div class="row m-0 p-0">
          <div class="col-md-12 col-xs-12 text-left">
            <span class="input-lable">Detail Activity</span>
            ...
            <table class="table table-bordered table-responsive">
              <thead>
                ...
                <tr>
                  ...
                  <th style="max-width: 70px">Duration (day)</th>
                  <!-- <th style="min-width: 200px">Timeline</th> -->
                  <th style="max-width: 50px">Date Plan</th>
                  <th style="max-width: 50px">Date Actual</th>
              ...
              <tbody>
                <tr v-for="(item, i) in containerThemaActivity" :key="i">
                  ...
                  <td>
                    <div class="input-group">
                      <select class="form-control" v-model="item.duration">
                  ...
                  <td class="text-center" v-if="item.date_actual">
                    {{ item.date_actual }}
                  </td>
                  <td></td>
                  <td>
                    <a href="" v-if="item.attachment">Lihat</a>
                    <input v-else class="form-control" type="file" />
                  </td>
                  <td>
        ...
        <div class="row m-0 p-0">
          <div class="col-md-12 col-xs-12 px-1 text-left">
            <span class="input-lable">GL Comment focus theme</span>
            <input
              class="form-control"
              type="text"
              v-model="gl_comment"
            ...
            />
            <div
              v-if="!gl_comment || gl_comment == ''"
              class="col text-secondary text-start fontSp"
            >
              No Comments
            </div>
          </div>
        ...
        <div class="row m-0 p-0">
          <div class="col-md-12 col-xs-12 px-1 text-left">
            <span class="input-lable">SH Comment focus theme</span>
            <input
              class="form-control"
              type="text"
              v-model="sh_comment"
        ...
        <div class="row m-0 p-0">
          <div class="col-md-12 col-xs-12 px-1 text-left">
            <span class="input-lable">Dph Comment focus theme</span>
            <input
              class="form-control"
              type="text"
              v-model="dph_comment"
              :disabled="setRole != 'DpH'"
            />
            <div
              v-if="!dph_comment || dph_comment == ''"
              class="col text-secondary text-start fontSp"
            >
              No Comments
            </div>
...
https://smartandonsys.web.app/editProblem?v_=${this.$route.query.v_}`
  ...
  components: {
    ScrollableContainer,
    LegendStatus,
    CardFTDesc: () => import("@/components/FocusTheme/CardFTDesc"),
    // ExcalamationInfo,
  },
  async mounted() {
    this.isLoading = true;
