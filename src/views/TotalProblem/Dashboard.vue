<template>
  <div class="container-fluid mt-2">
    ...
    <div class="row">
      <div class="col p-0 pl-1">
        <bar-total-problem
          v-if="selectedYear == 2022 && isDelayShow"
          :dataGraph="containerData"
        ></bar-total-problem>
        <bar-total-problem
          v-if="selectedYear == 2021 && isDelayShow"
          :dataGraph="containerData2021"
        ></bar-total-problem>
        <bar-total-problem
          v-if="selectedYear == 2020 && isDelayShow"
          :dataGraph="containerData2020"
        ></bar-total-problem>
      </div>
    </div>
    <div class="row">
