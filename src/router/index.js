...
import PdfViewerLongProb from "../views/Report/PdfViewerLongProb";
...
import ScatterMap from "../views/MtbfMttr/ScatterMap";
  ...
  // },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import("@/views/Symptom/Symptom.vue"),
        children: [
          {
            path: "parameter",
            name: "SymptomParameter",
            component: () => import("@/views/Symptom/SymptomParameter.vue"),
          },
          {
        ...
        children: [
          {
            path: "dashboard",
            name: "DashboardParam",
            component: () => import("@/views/Parameter/Dashboard.vue"),
          },
          {
            path: "administration",
          ...
          },
          {
            ...
            component: () => import("@/views/Parameter/DetailParameter.vue"),
          },
          {
            path: "history",
            name: "ParameterHistory",
            component: () => import("@/views/Parameter/ParameterHistory.vue"),
          },
          {
            path: "realtime",
            name: "RealtimeParameter",
            component: () => import("@/views/Parameter/RealtimeParameter.vue"),
          },
        ],
      },
      {
        ...
        component: () => import("@/views/TotalProblem/TotalProblem.vue"),
        children: [
          {
            path: "dashboard",
            name: "DashboardTotalProblem",
            component: () => import("@/views/TotalProblem/Dashboard.vue"),
          },
        ],
      },
      {
        ...
        component: () => import("@/views/OeeSummary/OeeSummary.vue"),
        children: [
          {
            path: "dashboard",
            name: "DashboardOee",
            component: () => import("@/views/OeeSummary/DashboardOee.vue"),
          },
        ],
      },
      {
        ...
        component: () => import("@/views/FocusTheme/FocusTheme"),
        children: [
          {
            path: "member",
            name: "DashboardFocusTheme",
            component: () => import("@/views/FocusTheme/DashboardFocusTheme"),
          },
          {
            path: "taskforce",
            name: "DashboardTaskForce",
            component: () => import("@/views/FocusTheme/DashboardTaskForce"),
          },
        ],
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            component: () => import("@/views/Quality/DetailQualityProblem.vue"),
          },
          {
            path: "editQuality",
            name: "EditQuality",
            component: () => import("@/views/Quality/EditQuality"),
          },
        ],
      },
      {
        ...
        children: [
          {
            path: "dashboard",
            component: () => import("@/views/Job/DashboardJob"),
          },
          {
            path: "dashboardA",
            component: () => import("@/views/Job/DashboardJobAudit"),
          },
          {
            path: "yamazumi",
            component: () => import("@/views/Job/YamazumiGraph"),
          },
          {
            path: "details",
            component: () => import("@/views/Job/DetailsJobMember"),
          },
        ],
      },
      {
      ...
      },
      {
        ...
        component: () => import("@/views/LTB/LTBReportScreen.vue"),
      },
    ],
  },
  {
    ...
    component: () => import("@/views/Tps/Tps.vue"),
    children: [
      {
        path: "dashboard",
        name: "DashboardTps",
        component: () => import("@/views/Tps/DashboardTps.vue"),
      },
      {
        path: "detail-data",
        name: "DetailDataTps",
        component: () => import("@/views/Tps/DetailDataTps.vue"),
      },
    ],
  },
];
